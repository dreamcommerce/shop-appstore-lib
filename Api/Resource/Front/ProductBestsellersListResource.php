...
class ProductBestsellersListResource extends FrontResource
{
    /**
    ...
    {
        return $this->execute($shop, [], ['currency' => $currencyName]);
    }
    ...
    protected function getUri(FrontShopInterface $shop, array $uriData): UriInterface
    {
        ...
        $uri = $uri->withPath($uri->getPath() . '/products/' . $uriData['currency'] . '/bestsellers');
