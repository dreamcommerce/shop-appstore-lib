...
class CategoryInfoResource extends FrontResource
{
    /**
     ...
     */
    public function getCategory(FrontShopInterface $shop, int $categoryId): DataInterface
    {
        return $this->execute(
            $shop,
            [],
    ...
    protected function getUri(FrontShopInterface $shop, array $uriData): UriInterface
    {
        ...
        $uri = $uri->withPath($uri->getPath() . '/categories/' . $uriData['id']);
