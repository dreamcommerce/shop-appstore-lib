...
class ProductRelatedListResource extends FrontResource
{
    /**
     ...
     */
    public function getProducts(FrontShopInterface $shop, int $productId, string $currencyName): DataInterface
    {
        return $this->execute(
            $shop, [],
            [
