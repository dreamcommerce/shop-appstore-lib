...
class ProductAskQuestionResource extends FrontResource
{
     ...
     */
    public function getProducts(FrontShopInterface $shop, int $productId): DataInterface
    {
        return $this->execute(
            $shop,
            [],
    ...
    protected function getUri(FrontShopInterface $shop, array $uriData): UriInterface
    {
        ...
        $uri = $uri->withPath($uri->getPath() . '/products/' . $uriData['id'] . '/ask-question');
