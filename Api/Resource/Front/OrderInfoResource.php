...
class OrderInfoResource extends FrontResource
{
    /**
     * {@inheritDoc}
     */
     ...
     */
    public function getOrder(FrontShopInterface $shop, int $orderId): DataInterface
    {
        return $this->execute(
            $shop,
            [],
    ...
    protected function getUri(FrontShopInterface $shop, array $uriData): UriInterface
    {
        ...
        $uri = $uri->withPath($uri->getPath() . '/user/orders/' . $uriData['id']);
